...
methods <- list(
  ...
  list(name = "rf_nwp_base", type = "base", dir = dir_rf_nwp),
  list(name = "lgbm_base", type = "base", dir = dir_lgbm),
  list(name = "lgbm_nwp_base", type = "base", dir = dir_lgbm_nwp),
  ...
  list(name = "ctwlsv_rf_nwp", type = "reco", dir = dir_ctwlsv_rf_nwp),
  list(name = "ctwlsv_lgbm", type = "reco", dir = dir_ctwlsv_lgbm),
  list(name = "ctwlsv_lgbm_nwp", type = "reco", dir = dir_ctwlsv_lgbm_nwp),
  ...
  list(name = "ctbu_rf_nwp", type = "reco", dir = dir_ctbu_rf_nwp),
  list(name = "ctbu_lgbm", type = "reco", dir = dir_ctbu_lgbm),
  list(name = "ctbu_lgbm_nwp", type = "reco", dir = dir_ctbu_lgbm_nwp),
